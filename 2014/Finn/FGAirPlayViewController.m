...
- (id)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        ...
        texts = @[@"Welcome to my WWDC app!",
                  @"Hi, I'm Finn and this is my WWDC 2014 scholarship application with Apple TV support.",
                  ...
                  @"",
                  @"The Festival of Code is Young Reqired State's biggest, annually happening event bringing together young developers from all over the UK and since this year from all over Europe. They all come together in teams and start building something in the timeframe of one week and at the weekend the three winners are honored in front of the whole assembly."
                  ];
        ...
        bg.image = [UIImage imageNamed:@"ggb.jpg"];
        ...
        welcome.font = [UIFont fontWithName:@"Helvetica Neue LT Com" size:w/12];
        ...
        title.font = [UIFont fontWithName:@"Helvetica Neue LT Com" size:120];
        ...
        description.font = [UIFont fontWithName:@"Futura-Normal" size:40];
    ...
    if (identifier != currentlyShowing) {
        ...
        dispatch_after(popTime, dispatch_get_main_queue(), ^(void){
            ...
            if (identifier == 1 && currentlyShowing != 1) {
                ...
                topLeftImage.image = [UIImage imageNamed:@"me"];
                title.text = @"Finn Gaida";
                description.text = texts[1];
                detailImage.image = [UIImage imageNamed:@"finng0"];
                newImg = [UIImage imageNamed:@"ggb.jpg"];
                
            } else if (identifier == 2 && currentlyShowing != 2) {
                
                topLeftImage.image = [UIImage imageNamed:@"wwdc"];
                title.text = @"About this app";
                description.text = texts[2];
                detailImage.image = [UIImage imageNamed:@"finng0"];
                newImg = [UIImage imageNamed:@"aboutBG.jpg"];
                
            } else if (identifier == 3 && currentlyShowing != 3) {
                
                topLeftImage.image = [UIImage imageNamed:@"me2.jpg"];
                title.text = @"More about me";
                description.text = texts[3];
                detailImage.image = [UIImage imageNamed:@"finng0"];
                newImg = [UIImage imageNamed:@"moreBG.jpg"];
                
            } else if (identifier == 4 && currentlyShowing != 4) {
                
                topLeftImage.image = [UIImage imageNamed:@"sunup"];
                title.text = @"SunUp";
                description.text = texts[4];
                detailImage.image = [UIImage imageNamed:@"sunup0"];
                newImg = [UIImage imageNamed:@"sunupBG.jpg"];
                
            } else if (identifier == 5 && currentlyShowing != 5) {
                
                topLeftImage.image = [UIImage imageNamed:@"stumbler"];
                title.text = @"PlateCollect";
                description.text = texts[5];
                detailImage.image = [UIImage imageNamed:@"stumbler0"];
                newImg = [UIImage imageNamed:@"stumblerBG.jpg"];
                
            } else if (identifier == 6 && currentlyShowing != 6) {
                
                topLeftImage.image = [UIImage imageNamed:@"brightness"];
                title.text = @"Brightness";
                description.text = texts[6];
                detailImage.image = [UIImage imageNamed:@"brightness0"];
                newImg = [UIImage imageNamed:@"brightnessBG.jpg"];
                
            } else if (identifier == 7 && currentlyShowing != 7) {
                
                topLeftImage.image = [UIImage imageNamed:@"youtheast"];
                title.text = @"YouthEast";
                description.text = texts[7];
                detailImage.image = [UIImage imageNamed:@"youtheast0"];
                newImg = [UIImage imageNamed:@"youtheastBG.jpg"];
                
            } else if (identifier == 8 && currentlyShowing != 8) {
                
                topLeftImage.image = [UIImage imageNamed:@"fabtap"];
                title.text = @"FabTap";
                description.text = texts[8];
                detailImage.image = [UIImage imageNamed:@"fabtap0"];
                newImg = [UIImage imageNamed:@"fabtapBG.jpg"];
                
            } else if (identifier == 9 && currentlyShowing != 9) {
                
                topLeftImage.image = [UIImage imageNamed:@"jugendhackt.jpg"];
                title.text = @"Jugend Hackt";
                description.text = texts[9];
                detailImage.image = [UIImage imageNamed:@""];
                newImg = [UIImage imageNamed:@"jugendhacktBG.jpg"];
                
            } else if (identifier == 10 && currentlyShowing != 10) {
                
                topLeftImage.image = [UIImage imageNamed:@"ict.JPG"];
                title.text = @"ICT 2013";
                description.text = texts[10];
                detailImage.image = [UIImage imageNamed:@""];
                newImg = [UIImage imageNamed:@"ictBG.jpg"];
                
            } else if (identifier == 11 && currentlyShowing != 11) {
                
                topLeftImage.image = [UIImage imageNamed:@"zugang.jpg"];
                title.text = @"Zugang Gestalten";
                description.text = texts[11];
                detailImage.image = [UIImage imageNamed:@""];
                newImg = [UIImage imageNamed:@"zugangBG.jpg"];
                
            } else if (identifier == 12 && currentlyShowing != 12) {
                
                topLeftImage.image = [UIImage imageNamed:@"pioneers.jpg"];
                title.text = @"Pioneers London";
                description.text = texts[12];
                detailImage.image = [UIImage imageNamed:@""];
                newImg = [UIImage imageNamed:@"pioneersBG.jpg"];
                ...
                detailImage.image = [UIImage imageNamed:@"windoge0"];
                newImg = [UIImage imageNamed:@"sunupBG.jpg"];
                ...
                topLeftImage.image = [UIImage imageNamed:@""];
                ...
                detailImage.image = [UIImage imageNamed:@"sunup1"];
                newImg = [UIImage imageNamed:@"sunupBG.jpg"];
                ...
                detailImage.image = [UIImage imageNamed:@"sunup2"];
                newImg = [UIImage imageNamed:@"sunupBG.jpg"];
                ...
                detailImage.image = [UIImage imageNamed:@"in-app"];
                newImg = [UIImage imageNamed:@"sunupBG.jpg"];
                
            } else if (identifier == 26 && currentlyShowing != 26) {
                
                topLeftImage.image = [UIImage imageNamed:@"petri.jpg"];
                ...
                topLeftImage.image = [UIImage imageNamed:@"rieke.jpg"];
                ...
                detailImage.image = [UIImage imageNamed:@"stolpersteine.jpg"];
                newImg = [UIImage imageNamed:@"stumblerBG.jpg"];
                ...
                topLeftImage.image = [UIImage imageNamed:@"earle.jpg"];
                ...
                topLeftImage.image = [UIImage imageNamed:@"anglin"];
                ...
                topLeftImage.image = [UIImage imageNamed:@"kingsley.jpg"];
                ...
                topLeftImage.image = [UIImage imageNamed:@"klimpel.jpg"];
                ...
                topLeftImage.image = [UIImage imageNamed:@"voss.jpg"];
                ...
                topLeftImage.image = [UIImage imageNamed:@"yrs"];
                ...
                topLeftImage.image = [UIImage imageNamed:@"hoesel.jpg"];
                ...
                topLeftImage.image = [UIImage imageNamed:@"izqui.jpg"];
                ...
                detailImage.image = [UIImage imageNamed:@"movie0"];
                newImg = [UIImage imageNamed:@"zugangBG.jpg"];
                
            } else if (identifier == 42 && currentlyShowing != 42) {
                
                topLeftImage.image = [UIImage imageNamed:@"thinkspace.jpg"];
                ...
                topLeftImage.image = [UIImage imageNamed:@"kramer.jpg"];
            ...
            if (identifier == 46) {
                ...
                screenshot1.image = [UIImage imageNamed:@"fabtap1"];
                screenshot2.image = [UIImage imageNamed:@"fabtap2"];
